        ...
        <div className="flex-1 p-6 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 text-xs font-mono">
            <div className="p-5 rounded-3xl border border-purple-500/30 bg-purple-950/20 space-y-1">
              <span className="text-[10px] text-purple-700 dark:text-purple-400 font-bold uppercase block font-sans">CAPITAL APORTADO</span>
            ...
            <div className="p-5 rounded-3xl border border-emerald-500/30 bg-emerald-950/20 space-y-1">
              <span className="text-[10px] text-emerald-700 dark:text-emerald-400 font-bold uppercase block font-sans">RENTABILIDAD ANUAL (APY)</span>
              <p className="text-2xl font-black text-emerald-700 dark:text-emerald-400">{currentInvestor.annualizedRoiPercent}%</p>
            ...
            <div className="p-5 rounded-3xl border border-blue-500/30 bg-blue-950/20 space-y-1">
              <span className="text-[10px] text-blue-700 dark:text-blue-400 font-bold uppercase block font-sans">DIVIDENDOS PAGADOS</span>
            ...
            <div className="p-5 rounded-3xl border border-amber-500/30 bg-amber-950/20 space-y-1">
              <span className="text-[10px] text-amber-700 dark:text-amber-400 font-bold uppercase block font-sans">DIVIDENDO ESTE MES</span>
              <p className="text-2xl font-black text-amber-700 dark:text-amber-400">{"$" + currentInvestor.pendingDividendsThisMonthUSD.toLocaleString("es-VE") } USD</p>
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700 dark:text-zinc-300 font-sans text-xs">
                      Cliente: <strong className="text-zinc-900 dark:text-zinc-100">{veh.clientName}</strong> • Cuota Mensual: <strong className="text-emerald-700 dark:text-emerald-400">{"$" + veh.monthlyQuotaUSD} USD</strong>
                    </p>
                  ...
                  <div className="flex-shrink-0">
                    <span className="text-[10px] bg-white dark:bg-zinc-900 text-purple-800 dark:text-purple-300 px-2.5 py-1 rounded font-mono border border-zinc-200 dark:border-zinc-800">
                      Garantía Activa
                    </span>
                  </div>
                </div>
