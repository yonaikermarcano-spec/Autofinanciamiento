                      ...
                      <tr key={s.staffId} className="hover:bg-white dark:bg-zinc-900/40">
                        ...
                        <td className="p-3 font-sans">
                          {s.role === "ASESOR_VENTAS" ? (
                            <div>
                              <strong className="text-emerald-400">{s.contractsClosedCount}</strong> de {s.monthlyTargetUnits} motos
                              {s.contractsClosedCount >= s.monthlyTargetUnits && (
                                <span className="ml-1 text-[9px] bg-emerald-500/20 text-emerald-300 px-1 py-0.2 rounded font-bold">META SUPERADA</span>
                              )}
                            </div>
                          ) : (
                            <div>
                              <span className="text-zinc-300">Recaudado: </span>
                              <strong className="text-emerald-400">{"$" + s.totalCollectedInFieldUSD} USD</strong>
                            </div>
                          )}
                        </td>
                      ...
                      {!isEditing ? (
                        <div className="space-y-1.5 text-xs text-zinc-300 font-mono">
                          {r.type === "FIXED_PER_CONTRACT" && (
                            <p>Monto Fijo por Venta: <strong className="text-emerald-400 text-sm font-bold">{"$" + r.fixedAmountUSD} USD</strong></p>
                          )}
                          {r.type === "PERCENTAGE_ON_COLLECTION" && (
                            <p>Comisión de Cobranza: <strong className="text-emerald-400 text-sm font-bold">{r.percentageRate}% del monto recuperado</strong></p>
                          )}
                          {r.type === "TIER_BONUS" && (
                            <>
                              ...
                              <p>Monto del Bono Extra: <strong className="text-amber-400 text-sm font-bold">{"$" + r.bonusAmountUSD} USD</strong></p>
                            </>
                          )}
                        </div>
                      ) : (
                          ...
                          {r.type === "FIXED_PER_CONTRACT" && (
                            <div>
                              ...
                              <input
                                ...
                                className="w-full p-2.5 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-emerald-400 font-bold font-mono text-sm"
                              />
                            </div>
                          )}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full p-2.5 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-amber-400 font-bold font-mono text-sm"
                                />
                              </div>
                            </div>
                          )}
